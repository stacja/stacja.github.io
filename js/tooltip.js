{
	...
	const tooltips = Array.from(document.querySelectorAll('.easytooltip'));
	class Tooltip {
		constructor(el) {
			this.DOM = {};
			this.DOM.el = el;
			this.type = this.DOM.el.getAttribute('data-type');
			this.DOM.trigger = this.DOM.el.querySelector('.easytooltip__trigger');
			this.DOM.triggerSpan = this.DOM.el.querySelector('.easytooltip__trigger-text');
			this.DOM.base = this.DOM.el.querySelector('.easytooltip__base');
			this.DOM.shape = this.DOM.base.querySelector('.easytooltip__shape');
			if( this.DOM.shape ) {
			...
			this.DOM.deco = this.DOM.base.querySelector('.easytooltip__deco');
			this.DOM.content = this.DOM.base.querySelector('.easytooltip__content');

			this.DOM.letters = this.DOM.content.querySelector('.easytooltip__letters');
			if( this.DOM.letters ) {
