...
title: "#360 Testowanie w Scali z Grą w Życie"
...
opis:
  informacje: |
    ...
    Naszym celem będzie przede wszystkim sprawdzenie:
       1. jak można w testach w Scali wycisnąć jeszcze więcej z komputera, 
       1. jak uczyć siebie i innych Scali (by nie była tylko "lepszą Javą"),
       1. jak pokazać, że programowanie funkcyjne i Scala nie są wcale takie straszne,
       1. jak zacząć wprowadzać Scalę i programowanie funkcyjne do ekosystemu zespołu/firmy w sposób ewolucyjny, poprzez testy, a nie rewolucję w kodzie produkcyjnym.
    ...
    **Wymagania techniczne:**
       1. znasz już podstawy Scali (bo od podstaw się nie uczymy) i już napisałeś/napisałaś w życiu jakieś testy jednostkowe,
       1. przed warsztatami zapoznałeś/zapoznałaś się z regułami Gry w Życie (dla oszczędności czasu),
       1. przychodzisz z własnym komputerem, masz na nim zainstalowane:
